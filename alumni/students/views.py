...
from . models import Notice ,Albums, Profile,FollowUser,MyPost,PostComment,PostLike,pictures, Branch
...
from . myserializer import BranchSerializer,UserSerializer, NoticeSerializer, ProfileSerializer, MyPostSerializer
...
class UsertViewSet(viewsets.ModelViewSet):
